...
export default function PostArticle() {
  ...
  return (
    <section className="bg-green-1 pt-20 pb-20 lg:pb-[120px] flex justify-center items-center text-white gap-20 lg:gap-[140px] flex-col lg:flex-row">
      ...
      <div className="mt-2">
        <h1 className="max-w-[437px] text-[25px] md:text-[30px] lg:text-[36px] font-semibold text-center lg:text-left">
          Ingin Artikelmu Dimuat di Lembaran Bayan?
        </h1>
        <p className="text-[16px] md:text-[18px] max-w-[500px] mt-4 text-center lg:text-left">
          Kirimkan draft artikelmu terkait UMKM, wisata, budaya, atau kegiatan yang ada di Bayan.
        </p>
        <button
          className="flex items-center gap-5 text-[18px] mt-5 font-medium py-2 mx-auto lg:mx-0"
